                                ...
                                <div class="col-md-4 col-12">
                                    <div class="card">
                                        <div class="card-body p-2">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <button class="btn btn-success w-100 btn-tooltip"
                                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Saya Hadir"
                                                ...
                                                <div class="col-6">
                                                    <button class="btn btn-warning w-100 btn-tooltip"
                                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Saya Ijin"
                                                        data-container="body" data-animation="true"
                                                        {{ is_null($absence) ? 'disabled' : '' }}>
                                                ...
                                                <div class="col-6">
                                                    <button class="btn btn-primary w-100 btn-tooltip"
                                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Saya Sakit"
                                                        data-container="body" data-animation="true"
                                                        {{ is_null($absence) ? 'disabled' : '' }}>
                                                ...
                                                <div class="col-6">
                                                    <button class="btn btn-danger w-100 btn-tooltip"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Saya Tidak Hadir" data-container="body" data-animation="true"
                                                        {{ is_null($absence) ? 'disabled' : '' }}>
